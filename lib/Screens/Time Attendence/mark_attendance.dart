      ...
      for (String id in widget.uid) {
        db.submitAttendance(
            AttendanceModel(
                ...
                attendanceDate: widget.date, employeeName: '', status: 'rejected'),);
      }
      Navigator.push(context, MaterialPageRoute(builder:  (context) => AttendanceManagement(),));
